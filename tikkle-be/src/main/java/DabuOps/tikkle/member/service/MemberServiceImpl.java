...
public class MemberServiceImpl implements MemberService {
    ...
    public Member createMemberByOauth2(Member member) {
        // 동일한 이메일이 존재하는지 확인.
        Optional<Member> optionalMember = memberRepository.findByEmailAndStateNot(member.getEmail(), MemberState.DELETED);
    ...
    public void verifyExistEmail(String email) {
        Optional<Member> optionalMember = memberRepository.findByEmailAndStateNot(email, MemberState.DELETED);
    ...
    public Member findExistMemberById(Long memberId) {
        Optional<Member> optionalMember = memberRepository.findByIdAndStateNot(memberId, MemberState.DELETED);
